...
`codeminer.api` provides a REST API wrapper for the [`codeminer`](https://github.com/codeminer-io/codeminer) package, enabling access to clinical code mappings through HTTP endpoints.
...
Visit `http://127.0.0.1:8000/__docs__/` for interactive API documentation.
